...
from .controllers import add_product, get_products, update_product, delete_product, get_products_by_id

main_bp = Blueprint('main', __name__)

main_bp.route('/api/products', methods=['POST'])(add_product)
main_bp.route('/api/products', methods=['GET'])(get_products)
main_bp.route('/api/products/<idProduct>', methods=['GET'])(get_products_by_id)
